...
def run(args: argparse.Namespace) -> int:
    ...
    if args.single_model:
        eval_common.extend(["--model", args.single_model])

    relevancy_cmd = [
        sys.executable,
        "-m",
        "atsn.relevancy_evaluator_batch",
        *eval_common,
        "--our-claims-dir",
        str(claims_dir),
        "--output",
    ...
    redundancy_cmd = [
        sys.executable,
        "-m",
        "atsn.redundancy_evaluator_batch",
        *eval_common,
        "--relevancy-input",
        str(relevancy_path),
        "--output",
    ...
    objectivity_cmd = [
        sys.executable,
        "-m",
        "atsn.objectivity_evaluator_batch",
        *eval_common,
        "--relevancy-input",
        str(relevancy_path),
        "--output",
    ...
    efficiency_cmd = [
        sys.executable,
        "-m",
        "atsn.efficiency_evaluator_batch",
        "--algorithm",
        "our",
        "--redundancy-input",
        str(redundancy_path),
